...
import com.example.anmolvpn.R;
import core.LocalVpnService;

import java.io.File;
import java.util.Calendar;

public class MainActivity extends Activity implements View.OnClickListener,
		OnCheckedChangeListener, LocalVpnService.onStatusChangedListener {
	...
	String readConfigUrl() {
		SharedPreferences preferences = getSharedPreferences("SmartProxy",
				MODE_PRIVATE);
	...
	public void onClick(View v) {
		...
		new AlertDialog.Builder(this)
				...
				.setItems(
						new CharSequence[] { getString(R.string.config_url_manual) },
						new OnClickListener() {
							@Override
							public void onClick(
	...
	private void showConfigUrlInputDialog() {
		...
		new AlertDialog.Builder(this).setTitle(R.string.config_url)
				.setView(editText)
				.setPositiveButton(R.string.btn_ok, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						configUrl = "http://pac.webdefence.global.blackspider.com:8082/proxy.pac";
	...
	public void onLogReceived(String logString) {
		...
		scrollViewLog.fullScroll(ScrollView.FOCUS_DOWN);
		GL_HISTORY_LOGS = textViewLog.getText() == null ? "" : textViewLog
				.getText().toString();
	}
			...
			if (isChecked) {
				...
				if (intent == null) {
					...
					startActivityForResult(intent,
							START_VPN_SERVICE_REQUEST_CODE);
				}
			} else {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_item_about:
			new AlertDialog.Builder(this)
					...
					.setNegativeButton(R.string.btn_more,
							new OnClickListener() {
								@Override
		...
		case R.id.menu_item_exit:
			...
			new AlertDialog.Builder(this).setTitle(R.string.menu_item_exit)
