...
public class TcpProxyServer implements Runnable {
	...
	public void run() {
		try {
			while (true) {
				m_Selector.select();
				Iterator<SelectionKey> keyIterator = m_Selector.selectedKeys()
						.iterator();
	...
	void onAccepted(SelectionKey key) {
		...
		try {
			...
			if (destAddress != null) {
				Tunnel remoteTunnel = TunnelFactory.createTunnelByConfig(
						destAddress, m_Selector);
